...
def add_data_args(parser):
    ...
    data.add_argument('--data-nthreads', type=int, default=12,
...
def set_data_aug_level(aug, level):
    ...
    if level >= 2:
        aug.set_defaults(max_random_h=100, max_random_s=100, max_random_l=100)
    if level >= 3:
        aug.set_defaults(max_random_rotate_angle=60, max_random_shear_ratio=0, max_random_aspect_ratio=0)
