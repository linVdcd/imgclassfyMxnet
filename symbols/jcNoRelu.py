...
def get_symbol(num_classes,**kwargs):
    ...
    data = mx.symbol.Dropout(name='drop', data=data, p=0.005)
    ...
    fire2_expand1x1 = mx.symbol.Convolution(name='fire2_expand1x1', data=fire2_squeeze1x1, num_filter=48,
    ...
    fire2_expand3x3 = mx.symbol.Convolution(name='fire2_expand3x3', data=fire2_squeeze1x1, num_filter=48,
    ...
    fire4_expand1x1 = mx.symbol.Convolution(name='fire4_expand1x1', data=fire4_squeeze1x1, num_filter=64,
                                            pad=(0, 0), kernel=(1, 1), stride=(1, 1), no_bias=False)
    fire4_relu_expand1x1 = mx.symbol.Activation(name='fire4_relu_expand1x1', data=fire4_expand1x1, act_type='relu')
    fire4_expand3x3 = mx.symbol.Convolution(name='fire4_expand3x3', data=fire4_squeeze1x1, num_filter=64,
                                            pad=(1, 1), kernel=(3, 3), stride=(1, 1), no_bias=False)
    ...
    fire5_expand1x1 = mx.symbol.Convolution(name='fire5_expand1x1', data=fire5_squeeze1x1, num_filter=96,
                                            pad=(0, 0), kernel=(1, 1), stride=(1, 1), no_bias=False)
    fire5_relu_expand1x1 = mx.symbol.Activation(name='fire5_relu_expand1x1', data=fire5_expand1x1, act_type='relu')
    fire5_expand3x3 = mx.symbol.Convolution(name='fire5_expand3x3', data=fire5_squeeze1x1, num_filter=96,
                                            pad=(1, 1), kernel=(3, 3), stride=(1, 1), no_bias=False)
    ...
    fire6_expand1x1 = mx.symbol.Convolution(name='fire6_expand1x1', data=fire6_squeeze1x1, num_filter=128,
                                            pad=(0, 0), kernel=(1, 1), stride=(1, 1), no_bias=False)
    fire6_relu_expand1x1 = mx.symbol.Activation(name='fire6_relu_expand1x1', data=fire6_expand1x1, act_type='relu')
    fire6_expand3x3 = mx.symbol.Convolution(name='fire6_expand3x3', data=fire6_squeeze1x1, num_filter=128,
                                            pad=(1, 1), kernel=(3, 3), stride=(1, 1), no_bias=False)
    ...
    conv10race = mx.symbol.Convolution(name='conv10race', data=drop6, num_filter=4, pad=(0, 0), kernel=(1, 1),
