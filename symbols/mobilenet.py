...
def get_symbol(num_classes, **kwargs):
    ...
    conv_13 = Conv(conv_13_dw, num_filter=512, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_13") # 7/7
    conv_14_dw = Conv(conv_13, num_group=512, num_filter=1024, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv_14_dw") # 7/7
    conv_14 = Conv(conv_14_dw, num_filter=512, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_14") # 7/7

    pool = mx.sym.Pooling(data=conv_14, kernel=(7, 7), stride=(1, 1), pool_type="avg",global_pool=True, name="global_pool")
