...
def get_symbol(num_classes=1000, **kwargs):
    ...
    # stage 1
    rate=1
    conv = Conv(data, 32*rate, kernel=(3, 3), stride=(2, 2), name="conv")
    conv_1 = Conv(conv, 32*rate, kernel=(3, 3), name="conv_1")
    conv_2 = Conv(conv_1, 64*rate, kernel=(3, 3), pad=(1, 1), name="conv_2")
    pool = mx.sym.Pooling(data=conv_2, kernel=(3, 3), stride=(2, 2), pool_type="max", name="pool")
    # stage 2
    conv_3 = Conv(pool, 80*rate, kernel=(1, 1), name="conv_3")
    conv_4 = Conv(conv_3, 192*rate, kernel=(3, 3), name="conv_4")
    pool1 = mx.sym.Pooling(data=conv_4, kernel=(3, 3), stride=(2, 2), pool_type="max", name="pool1")
    # stage 3
    in3a = Inception7A(pool1, 64*rate,
                       64*rate, 96*rate, 96*rate,
                       48*rate, 64*rate,
                       "avg", 32*rate, "mixed")
    in3b = Inception7A(in3a, 64*rate,
                       64*rate, 96*rate, 96*rate,
                       48*rate, 64*rate,
                       "avg", 64*rate, "mixed_1")
    in3c = Inception7A(in3b, 64*rate,
                       64*rate, 96*rate, 96*rate,
                       48*rate, 64*rate,
                       "avg", 64*rate, "mixed_2")
    in3d = Inception7B(in3c, 384*rate,
                       64*rate, 96*rate, 96*rate,
                       "max", "mixed_3")
    # stage 4
    in4a = Inception7C(in3d, 192*rate,
                       128*rate, 128*rate, 192*rate,
                       128*rate, 128*rate, 128*rate, 128*rate, 192*rate,
                       "avg", 192*rate, "mixed_4")
    in4b = Inception7C(in4a, 192*rate,
                       160*rate, 160*rate, 192*rate,
                       160*rate, 160*rate, 160*rate, 160*rate, 192*rate,
                       "avg", 192*rate, "mixed_5")
    in4c = Inception7C(in4b, 192*rate,
                       160*rate, 160*rate, 192*rate,
                       160*rate, 160*rate, 160*rate, 160*rate, 192*rate,
                       "avg", 192*rate, "mixed_6")
    in4d = Inception7C(in4c, 192*rate,
                       192*rate, 192*rate, 192*rate,
                       192*rate, 192*rate, 192*rate, 192*rate, 192*rate,
                       "avg", 192*rate, "mixed_7")
    in4e = Inception7D(in4d, 192*rate, 320*rate,
                       192*rate, 192*rate, 192*rate, 192*rate,
                       "max", "mixed_8")
    # stage 5
    in5a = Inception7E(in4e, 320*rate,
                       384*rate, 384*rate, 384*rate,
                       448*rate, 384*rate, 384*rate, 384*rate,
                       "avg", 192*rate, "mixed_9")
    in5b = Inception7E(in5a, 320*rate,
                       384*rate, 384*rate, 384*rate,
                       448*rate, 384*rate, 384*rate, 384*rate,
                       "max", 192*rate, "mixed_10")
    # pool
    pool = mx.sym.Pooling(data=in5b, kernel=(8, 8), stride=(1, 1),global_pool=True, pool_type="avg", name="global_pool")
